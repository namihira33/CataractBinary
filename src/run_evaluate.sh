#核2クラス分類 回転断面
python3 ./src/evaluate.py 540 spin type=N

#皮質2クラス分類 回転断面
python3 ./src/evaluate.py 541 spin type=C

#後嚢2クラス分類 回転断面
python3 ./src/evaluate.py 542 spin type=P


#核二値分類 ベースライン
#python3 ./src/evaluate.py 517 horizontal type=N


#皮質二値分類 ベースライン
#python3 ./src/evaluate.py 386 horizontal type=C

#皮質二値分類 ベスト
#python3 ./src/evaluate.py 396 horizontal type=C


#python3 ./src/evaluate.py 384 horizontal type=C
#python3 ./src/evaluate.py 520 horizontal type=C
#python3 ./src/evaluate.py 521 horizontal type=C
